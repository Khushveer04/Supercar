...
public class table_commande {
	...
	// POUR POUVOIR OUVRIR LA PAGE DANS UNE AUTRE INTERFACE
	...
	//COMPTEUR POUR LE NOMBRE DE COMMANDES
	...
	// COMPTEUR POUR LE NOMBRE DE COMMANDES TERMINE
	...
	// COMPTEUR POUR LE NOMBRE DE COMMANDES EN COURS
	...
	// COMPTEUR POUR LE NOMBRE DE COMMANDES DEJA PASSE
	...
	public void table_load() {
		try {
			//REQUETE SQL POUR AFFICHER LES DONNEES DES TABLES
			...
			//INITIALISATION DES VARIABLES DES DIFFERENTS TABLES
	...
	private void initialize(String login) {
		...
		//BOUTTON POUR SORTIR DE L'INTERFACE COMMANDE
